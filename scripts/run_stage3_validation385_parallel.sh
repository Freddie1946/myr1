...
MODEL="$INSTALL/runs/stage3_process_grpo/kimi26_50step_seed42_20260730/output_attempt03"
DATA="$INSTALL/data/pathmmu_image_disjoint_v2/rewritten_records/validation_0385.json"
CHAT_TEMPLATE="$MODEL/chat_template.json"
RUN_ROOT="$INSTALL/runs/stage3_process_grpo/kimi26_50step_seed42_20260730/validation_0385_postpilot_parallel_20260730_101722"
